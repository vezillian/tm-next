...
const Navbar = () => {
  ...
  return (
    <header className="bg-[#0C1433] fixed top-0 w-full z-50 py-3">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <ul className="flex space-x-20">
              <li>
                <Link href="/" className="text-white hover:text-yellow-600 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white hover:text-yellow-600 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/#clients" className="text-white hover:text-yellow-600 transition-colors">
                  Clients
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-white hover:text-yellow-600 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/#contact" className="text-white hover:text-yellow-600 transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
